...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Live2dAdmin": () => (/* binding */ Live2dAdmin)
/* harmony export */ });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _lib_live2dWebSDK__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lib/live2dWebSDK */ "./src/lib/live2dWebSDK.ts");
...
class Live2dAdmin {
    ...
    initLogin() {
        let that = this;
        if (this.userInfo.errorCode == 200 && this.userInfo.userName) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnLogin").hide();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(".lgoined").show();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#labLogined").html(`${this.userInfo.userName} 已登录`);
        }
        else {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnLogin").show();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(".lgoined").hide();
        }
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#btnLogin").on("click", function () {
            let ref = encodeURIComponent(`${that.homeUrl}`);
            let width = 500;
            let height = 680;
    ...
    initControl() {
        var that = this;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.group').hide();
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-tab-wrapper a').removeClass('nav-tab-active');
        var activetab = '';
        if (typeof (localStorage) !== 'undefined') {
            activetab = localStorage.getItem("activetab");
        }
        if (activetab !== '' && jquery__WEBPACK_IMPORTED_MODULE_0___default()(activetab).length) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(activetab).fadeIn();
        }
        else {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('.group:first').fadeIn();
        }
        if (activetab !== '' && jquery__WEBPACK_IMPORTED_MODULE_0___default()(activetab + '_btn').length) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(activetab + '_btn').addClass('nav-tab-active');
        }
        else {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('#settings_btn').addClass('nav-tab-active');
        }
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-tab-wrapper a').on("click", function (evt) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav-tab-wrapper a').removeClass('nav-tab-active');
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('nav-tab-active');
            var clicked_group = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href');
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('.group').hide();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(clicked_group).fadeIn();
            evt.preventDefault();
            if (typeof (localStorage) !== 'undefined') {
                localStorage.setItem("activetab", clicked_group);
            }
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('input.addbtn').on("click", function () {
            var optName = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('optname');
            var keyName = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('keyname');
            var arrType = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('arrtype');
            that.addMsgInput(optName, keyName, this, arrType);
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('input.delbtn').on("click", function () {
            var optName = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('optname');
            var keyName = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('keyname');
            var arrType = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('arrtype');
            that.delMsgInput(optName, keyName, this, arrType);
        });
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('input[type=range]').on('input propertychange', function () {
            let val = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val();
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).next('.result').html(`${val}`);
        });
    }
    addMsgInput(optName, clsName, obj, typeName) {
        var that = this;
        var txtList = jquery__WEBPACK_IMPORTED_MODULE_0___default()('p.' + clsName);
        ...
        txtClone.children('input.delbtn').attr('name', clsName + '_delbtn' + indexNum)
            ...
            .on('click', function () {
            that.delMsgInput(optName, clsName, this, typeName);
        });
        txtList.last().after(txtClone);
    }
    delMsgInput(optName, clsName, obj, typeName) {
        var otherTxt = jquery__WEBPACK_IMPORTED_MODULE_0___default()(obj).parent().siblings('.' + clsName);
        if (otherTxt.length == 0)
            return;
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(obj).parent().fadeOut("fast", function () {
            var allTxt = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('.' + clsName);
            allTxt.each(function (i, e) {
                switch (typeName) {
                    case 'Selector':
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).children('.selector').attr('name', optName + '[' + clsName + '][' + i + '][selector]')
                            .attr('id', clsName + '_' + i + '_selector');
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).children('.text').attr('name', optName + '[' + clsName + '][' + i + '][text]')
                            .attr('id', clsName + '_' + i + '_text');
                        break;
                    case 'Array':
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).children('input:eq(0)').attr('name', optName + '[' + clsName + '][' + i + '][0]')
                            .attr('id', clsName + '_' + i + '_0');
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).children('input:eq(1)').attr('name', optName + '[' + clsName + '][' + i + '][1]')
                            .attr('id', clsName + '_' + i + '_1');
                        break;
                    case 'List':
                        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).children('input.textArray').attr('name', optName + '[' + clsName + '][' + i + ']')
                            .attr('id', clsName + '_' + i);
                        break;
                }
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).children('input.delbtn').attr('id', clsName + '_delbtn' + i)
                    .attr('name', clsName + '_delbtn' + i);
            });
            this.remove();
        });
    }
    getModelList(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            const sdk = new _lib_live2dWebSDK__WEBPACK_IMPORTED_MODULE_1__.Live2dWebSDK();
            const result = yield sdk.GetModelList(settings);
            if (result.length > 0) {
                const listDiv = document.querySelector('.live2d-container');
                result.forEach(element => {
                    ...
                    dlAnchor.classList.add('install-now');
                    dlAnchor.classList.add('button');
                    downBtn.appendChild(dlAnchor);
                    itemDiv.append(thumb, title, downBtn);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Live2dWebSDK": () => (/* binding */ Live2dWebSDK)
/* harmony export */ });
...
var keys = __webpack_require__(/*! ./client.pem */ "./src/lib/client.pem");
class Live2dWebSDK {
    constructor() {
        this.domain = 'https://api.live2dweb.com';
    }
    VerifySignAPI(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = keys.default;
            const publicKey = yield jose__WEBPACK_IMPORTED_MODULE_0__.importSPKI(key, 'RS256');
            const { payload } = yield jose__WEBPACK_IMPORTED_MODULE_0__.jwtVerify(token.sign, publicKey);
            const response = yield fetch(`${this.domain}/Verify`, {
                method: 'post',
                headers: new Headers({
                    'Authorization': `Bearer ${token.sign}`,
                    'Content-Type': 'application/x-www-form-urlencoded'
                }),
                body: `uid=${payload.certserialnumber}`
            }).then(res => res.text());
            const body = yield this.DecodeJWToken(response);
            return body.payload.code == 200;
        });
    }
    DecodeJWToken(token, key = null) {
        return __awaiter(this, void 0, void 0, function* () {
            if (key == null) {
                key = keys.default;
            }
            const publicKey = yield jose__WEBPACK_IMPORTED_MODULE_0__.importSPKI(key, 'RS256');
            return yield jose__WEBPACK_IMPORTED_MODULE_0__.jwtVerify(token, publicKey);
        });
    }
    GetModelList(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch(`${this.domain}/model/list`, {
                method: 'get',
                headers: new Headers({
                    'Authorization': `Bearer ${token.sign}`,
...
"use strict";
/*!**********************************!*\
  !*** ./src/Waifu/waifu-admin.js ***!
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _live2d_admin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./live2d-admin */ "./src/Waifu/live2d-admin.ts");

var waifuAdmin = new _live2d_admin__WEBPACK_IMPORTED_MODULE_0__.Live2dAdmin(settings);
window.onload = () => {
  waifuAdmin.initLogin();
  waifuAdmin.initControl();
};
window.getModelList = waifuAdmin.getModelList;
})();

/******/ })()
;
//# sourceMappingURL=waifu-admin.min.js.map